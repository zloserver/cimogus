        ...
        ColumnLayout {
                ...
                clickedFunction: function() {
                    ...
                    if (GC.isMobile()) {
                        ...
                        fileName = SystemController.getFileName(qsTr("Save"),
                                                                qsTr("Logs files (*.log)"),
                                                                StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/ZloVPN",
                                                                true,
                                                                ".log")
                    }
                    if (fileName !== "") {
            ...
            LabelWithButtonType {
                ...
                clickedFunction: function() {
                    var fileName = ""
                    if (GC.isMobile()) {
                        fileName = "ZloVPN-service.log"
                    } else {
                        fileName = SystemController.getFileName(qsTr("Save"),
                                                                qsTr("Logs files (*.log)"),
                                                                StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/ZloVPN-service",
                                                                true,
                                                                ".log")
                    }
                    if (fileName !== "") {
